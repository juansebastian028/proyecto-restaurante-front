...
export class ModifierGroupService {
  ...
  getModifierGroups(): Observable<ModifierGroup[]> {
    return this.http.get<ModifierGroup[]>(
      `${this.path}/products/group-modifiers`,
  ...
  postModifierGroup(modifierGroup: ModifierGroup): Observable<ModifierGroup> {
    return this.http.post<ModifierGroup>(
      `${this.config.path}/products/group-modifiers`,
      modifierGroup,
      { headers: this.getHeaders() }
    );
  }
  ...
  putModifierGroup(id: number, modifierGroup: ModifierGroup) {
    return this.http.put(
      `${this.path}/products/group-modifiers/${id}`,
      modifierGroup,
      { headers: this.getHeaders() }
    );
  }
  ...
  deleteModifierGroup(id: number) {
    return this.http.delete(`${this.path}/products/group-modifiers/${id}`, {
      headers: this.getHeaders(),
    });
  }
}
