  ...
  onFormSubmit() {
    ...
    if (this.form.valid) {
      ...
      this.form.addControl(
        'branch_id',
        this.fb.control(this.user.branch_office_id)
      );
      this.form.addControl(
        'shopping_cart_ids',
        this.fb.control(JSON.parse(localStorage.getItem('payShoppingCart')!))
      );
      this._order.payOrder(this.form.value).subscribe(
        (data) => {
