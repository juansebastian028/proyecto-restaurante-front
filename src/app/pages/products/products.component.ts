...
export class ProductsComponent implements OnInit {
  ...
  onProductFormSubmit(obj: any) {
    if (obj.id > 0) {
      ...
      this._product.putProduct(obj.id, obj.formDataProduct).subscribe(
        (data) => {
          this.getProducts();
      ...
      this._product.postProduct(obj.formDataProduct).subscribe(
        (data) => {
          this.getProducts();
          this._snackbar.openSnackBar(
